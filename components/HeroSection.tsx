...
export default function HeroSection({ onCareerSelect }: HeroSectionProps) {
  ...
  return (
    <section className="pb-10 pt-14 text-center sm:pb-16 sm:pt-28">
      ...
      <p className="mx-auto mb-8 max-w-2xl text-base leading-relaxed text-zinc-400 sm:mb-10 sm:text-xl">
