...
async function main() {
  ...
  // Target @SahilBloom — always has career-relevant content
  const account = "SahilBloom";
  ...
  if (!tweet) throw new Error("No tweets");

  console.log(`🎯 @${account}: "${tweet.text.slice(0, 120)}..."\n`);
...
- Add a unique perspective — don't just agree
...
Output ONLY the reply text.`,
  ...
  // Reply using tweet() with reply params
